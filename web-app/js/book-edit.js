...
function foundLocationCreate(position) {
	 $("#input-book-latitude").val(position.coords.latitude);
	 $("#input-book-longitude").val(position.coords.longitude);
...
function showBook(id) {
    ...
    showMap(book.latitude, book.longitude);
